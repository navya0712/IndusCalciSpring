...
public class StudentService {
	...
	public void saveToFile(Student student) {
		String fileName = "student_" + student.getId() + "." + getFileExtension();
	...
	public Student loadFromFile(int studentId) {
		String fileName = "student_" + studentId + "." + getFileExtension();
		String filePath = Paths.get(directoryPath, fileName).toString();
	...
	private String getFileExtension() {
		if (converter instanceof com.indus.training.core.impl.JsonConverter
				|| converter instanceof com.indus.training.core.impl.JsonConverterUsingJackson) {
			return "json";
		} else if (converter instanceof com.indus.training.core.impl.XmlConverter
				|| converter instanceof com.indus.training.core.impl.XmlConverterUsingJackson) {
			return "xml";
		} else {
